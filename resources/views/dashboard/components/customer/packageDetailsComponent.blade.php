...
<div class="container my-4">
    ...
    <div class="container my-5">
        ...
        <section id="printable_package_section">
        ...
        <!-- Full Package Details Table -->
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-body">
                    <table class="table avoid-page-break table-bordered table-striped table-sm align-middle" style="border-collapse: collapse; width: 100%;">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <th style="border: 1px solid #000; padding: 8px">Visa Online</th>
 ...
 $('.previewPackagePdf').on('click', async function () {
        ...
        try {
            const opt = {
                ...
                jsPDF: {
                    unit: 'pt',
                    format: 'a3', // 🟢 Use A3 for large page
