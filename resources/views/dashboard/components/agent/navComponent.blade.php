 <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
     ...
     <span class="text-white text-center">Wellcome Back To <b class="agent_name"></b> Dashboard</span>
     <!-- Navbar Search-->
     ...
     <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
         <li class="nav-item dropdown">
             ...
             <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                 <li>
                     <a class="dropdown-item nav_agent_user_name" href="#!">
                         <i class="fas fa-id-badge me-2"></i><span class="nav_agent_user_code"></span>
                     </a>
                 </li>
                 ...
                 <li class="dropdown-item">
                     <i class="fas fa-user-tag me-2"></i>Role: <span class="nav_agent_user_role"></span>
                 </li>
                  <li>
