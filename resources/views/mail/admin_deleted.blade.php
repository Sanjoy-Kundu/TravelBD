...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>We want to inform you that your admin account associated with the email <strong>{{ $adminEmail }}</strong> has been <span class="highlight">deleted successfully</span> by the system administrator.</p>
