...
<body>
            ...
            <div class="wrap-login100 animate__animated animate__fadeIn">
                ...
                <form class="login100-form">
                    ...
                    <div class="container-login100-form-btn d-flex flex-column align-items-center">
                        ...
                        <!-- Resend OTP Button -->
                        <a href="javascript:void(0);" class="btn-sm px-4 text-danger resendagentOtp">
    ...
    <script>
        ...
        async function onOtpVerify(event) {
            ...
            try {
                const res = await axios.post("/agent/otp/verify/store", {
                    otp: otp
                });
        ...
        $(document).on('click', '.resendagentOtp', async function() {
            let email = localStorage.getItem('pending_email');
            if (!email) {
                window.location.href = "/agent/login";
                return;
            ...
            try {
                let res = await axios.post('/agent/resend/otp', {
                    email: email
                });
