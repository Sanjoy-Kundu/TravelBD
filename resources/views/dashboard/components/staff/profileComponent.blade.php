        ...
        <div class="card-body">
            <form action="" method="" enctype="multipart/form-data" id="staff_profile_form">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-success px-4" onclick="staffProfileUpload(event)">Save Profile</button>
                    <button type="submit" class="btn btn-primary px-4"><a href="{{url('/staff/view/profile')}}" target="_blank" style="text-decoration: none; color:white">View Profile</a></button>
                </div>
            </form>
        </div>
    </div>
